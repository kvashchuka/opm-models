...
/*!
 * \file
 * \copydoc Opm::/home/anna/OPM_withDuneFem/opm-material/opm/material/components/Artificial_liquid.hpp
 */
#ifndef OPM_ARTIFICIAL_LIQUID_HPP
#define OPM_ARTIFICIAL_LIQUID_HPP
 ...
 * \ingroup Components
 *
 * \brief A version of pure water with viscosity 1.0.
 *
 * We need such components for simple transport problem
 *
 * \tparam Scalar The type used for representing scalar values
 */
template <class Scalar>
class Artificial_liquid : public Component<Scalar, Artificial_liquid<Scalar> >
{
...
public:
    ...
    {
        //OPM_THROW(std::logic_error, "The liquid pressure is undefined for incompressible fluids");
    }
...
template <class Scalar>
const Scalar Artificial_liquid<Scalar>::R = Opm::Constants<Scalar>::R / 18e-3;
