...
/*!
 * \file
 * \copydoc Opm::PureTransport
 */
#ifndef OPM_PURE_TRANSPORT_HPP
#define OPM_PURE_TRANSPORT_HPP
...
class PureTransport : public TraitsT
{
...
public:
    ...
    static void capillaryPressures(Container& values, const Params& params, const FluidState& fs)
    {
        ...
        values[Traits::nonWettingPhaseIdx] = 0.0; //pcnw<FluidState, Evaluation>(params, fs);
    }
    ...
    {
        throw std::runtime_error("Not implemented: PureTransport::saturations()");
    ...
    {
        throw std::runtime_error("Not implemented: PureTransport::pcnw");

        const auto& Sw = Opm::decay<Evaluation>(fs.saturation(Traits::wettingPhaseIdx));
        return 0.0; //twoPhaseSatPcnw(params, Sw);
    }

    template <class Evaluation>
    static Evaluation twoPhaseSatPcnw(const Params& params, const Evaluation& Sw)
    {
        throw std::runtime_error("Not implemented: PureTransport::twoPhaseSatPcnw");
    ...
    {
        const auto& Sw = Opm::decay<Evaluation>(fs.saturation(Traits::wettingPhaseIdx));
        return Sw; //twoPhaseSatKrw(params, Sw);
    }

    template <class Evaluation>
    static Evaluation twoPhaseSatKrw(const Params& params, const Evaluation& Sw)
    {
        throw std::runtime_error("Not implemented: twoPhaseSatKrw()");
    ...
    {
        const Evaluation& Sn = Opm::decay<Evaluation>(fs.saturation(Traits::nonWettingPhaseIdx));
        return Sn; //twoPhaseSatKrn(params, Sw);
    }

    template <class Evaluation>
    static Evaluation twoPhaseSatKrn(const Params& params, const Evaluation& Sw)
    {
        throw std::runtime_error("Not implemented: twoPhaseSatKrn()");
