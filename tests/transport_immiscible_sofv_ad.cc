...
#include "problems/transportproblem.hh"

BEGIN_PROPERTIES

NEW_TYPE_TAG(TransportProblemSofvAd, INHERITS_FROM(ImmiscibleTwoPhaseModel, TransportBaseProblem));
...
SET_TAG_PROP(TransportProblemSofvAd, SpatialDiscretizationSplice, SofvDiscretization);

// use automatic differentiation for this simulator
SET_TAG_PROP(TransportProblemSofvAd, LocalLinearizerSplice, AutoDiffLocalLinearizer);
...
{
    typedef TTAG(TransportProblemSofvAd) ProblemTypeTag;
